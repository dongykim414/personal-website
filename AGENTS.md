...
이 프로젝트는 김동영 프론트엔드 개발자의 웹 이력서와 프로젝트 포트폴리오다.

채용 담당자가 메인에서 경력과 기여를 빠르게 파악하고, 개발 리더가 프로젝트 상세에서 기술적 판단과 구현을 읽을 수 있는 담백한 사이트를 만든다. 프로젝트와 연결된 작은 데모는 샘플임을 명시하며 본문을 보조한다.
